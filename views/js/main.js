...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  //changed number of gen pizzas to 35 from 200
  for (var i = 0; i < 35; i++) {
  ...
  //moved items variable here so its not called everytime you scroll
  //and run updatePositions
  items = document.getElementsByClassName('mover');
  updatePositions();
});
//moved var outside updatePositions so it doesnt have recalculate
//everytime user scrolls
